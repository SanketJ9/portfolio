...
export default function Contact() {
  ...
  return (
    <div ref={containerRef} data-scroll className="contact-cont container relative mx-auto flex h-[100svh] max-w-[1280px] snap-start flex-col-reverse items-center justify-between md:justify-evenly font-body pb-16 md:pb-0 sm:h-screen sm:flex-row sm:justify-between z-30">
